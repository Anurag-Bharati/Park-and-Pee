...
import com.aramb.parkandpee.model.UploadFileResponse;
import com.aramb.parkandpee.services.impl.FileStorageServiceImpl;
...
public class FileController {
    ...
    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file, @RequestParam("id") int id, @RequestParam("type") String type) {
