...
class _MapViewState extends State<AddServiceDetailsPee> {
                                      ...
                                      onPressed: () {
                                        ...
                                        if (textController1.text.length < 3) {
                                          ...
                                          if (_amenity1 == false &&
                                            ...
                                            _scaffoldKey.currentState
                                                ?.showSnackBar(showSnackBar(
                                                    "Male or Female or both amenity must be enabled to proceed.",
                                                    context,
                                                    Colors.red[400],
                                                    2));
                                          } else if (_amenity5 == false) {
                                            _scaffoldKey.currentState
                                                ?.showSnackBar(showSnackBar(
                                                    "Handwash service is mandatory",
                                                    context,
                                                    Colors.red[400],
                                                    2));
                                          } else {
