...
class MySoSetting extends StatefulWidget {
  const MySoSetting({Key? key}) : super(key: key);

  @override
  _MySoSettingstate createState() => _MySoSettingstate();
}

class _MySoSettingstate extends State<MySoSetting> {
  @override
